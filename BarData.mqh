...
public:
   ...
   int getLowestLowValueByRange(int startIndex, int count){
      return ArrayMinimum(m_low, startIndex, count);
   }
   ...
   int getHighestHighValueByRange(int startIndex, int count){
      return ArrayMaximum(m_high, startIndex, count);
   }
